...
<html lang="es">
    ...
    <body>
        <h1>Titulo de prueba {{$data['titulo']}}</h1>
        <hr>
        <div class="contenido">
            <p id="primero">{{$data['total']}}Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore nihil illo odit aperiam alias rem voluptatem odio maiores doloribus facere recusandae suscipit animi quod voluptatibus, laudantium obcaecati quisquam minus modi.</p>
